declare namespace NpmCheck {
  ...
  interface INpmCheckCurrentState {
    ...
    set: (key: INpmCheckGetSetValues, val: unknown) => void;
  }

  interface INpmCheckPackage {
    moduleName: string; // name of the module.
    homepage: string; // url to the home page.
    regError: unknown; // error communicating with the registry
    pkgError: unknown; // error reading the package.json
    ...
    packageWanted: string; // Requested version from the parent package.json.
